 ...
 */
 ...
 function fight_music(fms) {
   var bg_audio_node = document.getElementById("bgmusic");
   var fg_audio_node = document.getElementById("fgmusic");
   ...
   if (fms == "on") {
		bg_audio_node.pause();
		  ...
		  if (enemy_gv  == 7){
			fg_audio_node.loop = false;	
			fg_audio_node.pause();
			fg_audio_node.src = "music/boss_taunt.mp3";
			fg_audio_node.load();
		
			setTimeout(function() {fg_audio_node.src = "music/fight_boss.mp3";},14500);

			
			} else {
			
		fg_audio_node.src = "music/fight.mp3";
		}
		fg_audio_node.loop = true;
		fg_audio_node.load();
		//fg_audio_node.play();
   } else {
		fg_audio_node.pause();
